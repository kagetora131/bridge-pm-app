...
// the calendar's period bars something meaningful to show. Due dates are kept
// in sync with docs/bridge_pm_dummy_data.json, which is dated against a
// 2026-09-12 viewing baseline — tk05 is the one deliberately-left-overdue
// task, used to verify the calendar's risk highlighting. titleEn /
// translationStatus / actualProgress are demo values not in the source JSON —
// pj02 is deliberately left untranslated to show the Japanese-title fallback.
export const seedTasks: Task[] = [
  { id: 'tk01', projectId: 'pj01', titleJa: 'リリース版シナリオ最終稿確定', titleEn: 'Finalize the release scenario script', descriptionJa: '', descriptionEn: '', translationStatus: 'reviewed', assigneeId: 'st01', startDate: '2026-05-01', dueDate: '2026-06-01', status: 'done', actualProgress: 100, dependsOn: null, createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk02', projectId: 'pj01', titleJa: '英語版QAテスト', titleEn: 'QA testing of the English build', descriptionJa: '', descriptionEn: '', translationStatus: 'reviewed', assigneeId: 'st04', startDate: '2026-06-02', dueDate: '2026-07-15', status: 'done', actualProgress: 100, dependsOn: 'tk01', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk03', projectId: 'pj01', titleJa: 'スペイン語ローカライズ・QA', titleEn: 'Spanish localization & QA', descriptionJa: '', descriptionEn: '', translationStatus: 'reviewed', assigneeId: 'st06', startDate: '2026-07-16', dueDate: '2026-09-20', status: 'in-progress', actualProgress: 80, dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk04', projectId: 'pj01', titleJa: 'フランス語ほかEU諸語ローカライズ・QA', titleEn: 'French & other EU languages localization & QA', descriptionJa: '', descriptionEn: '', translationStatus: 'reviewed', assigneeId: 'st07', startDate: '2026-07-16', dueDate: '2026-09-22', status: 'in-progress', actualProgress: 90, dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk05', projectId: 'pj01', titleJa: 'アラビア語ローカライズ', titleEn: 'Arabic localization', descriptionJa: '', descriptionEn: '', translationStatus: 'draft', assigneeId: 'st13', startDate: '2026-07-16', dueDate: '2026-09-08', status: 'todo', actualProgress: null, dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk06', projectId: 'pj01', titleJa: '英語版フルボイス収録', titleEn: 'Full English voice-over recording', descriptionJa: '', descriptionEn: '', translationStatus: 'reviewed', assigneeId: 'st11', startDate: '2026-07-16', dueDate: '2026-09-25', status: 'todo', actualProgress: null, dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk07', projectId: 'pj01', titleJa: '北米向けプロモーション計画', titleEn: 'North America promotion plan', descriptionJa: '英語吹替素材が完成するまでプロモ動画を作れずブロック中。', descriptionEn: "Blocked: promo videos can't be produced until the English voice-over assets are finished.", translationStatus: 'draft', assigneeId: 'st09', startDate: '2026-09-26', dueDate: '2026-10-05', status: 'blocked', actualProgress: null, dependsOn: 'tk06', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk08', projectId: 'pj01', titleJa: 'EU圏向けプロモーション計画', titleEn: 'EU promotion plan', descriptionJa: '', descriptionEn: '', translationStatus: 'draft', assigneeId: 'st08', startDate: '2026-09-23', dueDate: '2026-10-05', status: 'todo', actualProgress: null, dependsOn: 'tk04', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk09', projectId: 'pj01', titleJa: '北米メディア向けプレスリリース', titleEn: 'Press release for North American media', descriptionJa: '', descriptionEn: '', translationStatus: 'draft', assigneeId: 'st12', startDate: '2026-10-06', dueDate: '2026-10-12', status: 'todo', actualProgress: null, dependsOn: 'tk07', createdAt: '2026-05-01T00:00:00.000Z' },
  // ネオトーキョー2088 (pj02): art → program integration (rough model) → QA on the early build.
  { id: 'tk10', projectId: 'pj02', titleJa: 'アート素材制作(主人公キャラクターデザイン確定)', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st03', startDate: '2026-07-01', dueDate: '2026-09-25', status: 'in-progress', actualProgress: 70, dependsOn: null, createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk11', projectId: 'pj02', titleJa: 'キャラクター実装(仮モデル)', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st02', startDate: '2026-09-26', dueDate: '2026-10-10', status: 'todo', actualProgress: null, dependsOn: 'tk10', createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk12', projectId: 'pj02', titleJa: '初期ビルド動作確認', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st10', startDate: '2026-10-11', dueDate: '2026-10-25', status: 'todo', actualProgress: null, dependsOn: 'tk11', createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk13', projectId: 'pj03', titleJa: '起承転結プロット第1稿', titleEn: 'First draft of the four-act story plot', descriptionJa: '', descriptionEn: '', translationStatus: 'draft', assigneeId: 'st01', startDate: '2026-08-01', dueDate: '2026-09-18', status: 'in-progress', actualProgress: 85, dependsOn: null, createdAt: '2026-08-01T00:00:00.000Z' },
];
