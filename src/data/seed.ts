...
// task, used to verify the calendar's risk highlighting.
export const seedTasks: Task[] = [
  ...
  { id: 'tk03', projectId: 'pj01', titleJa: 'スペイン語ローカライズ・QA', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st06', startDate: '2026-07-16', dueDate: '2026-09-20', status: 'in-progress', dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk04', projectId: 'pj01', titleJa: 'フランス語ほかEU諸語ローカライズ・QA', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st07', startDate: '2026-07-16', dueDate: '2026-09-22', status: 'in-progress', dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk05', projectId: 'pj01', titleJa: 'アラビア語ローカライズ', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st13', startDate: '2026-07-16', dueDate: '2026-09-08', status: 'todo', dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk06', projectId: 'pj01', titleJa: '英語版フルボイス収録', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st11', startDate: '2026-07-16', dueDate: '2026-09-25', status: 'todo', dependsOn: 'tk02', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk07', projectId: 'pj01', titleJa: '北米向けプロモーション計画', titleEn: '', descriptionJa: '英語吹替素材が完成するまでプロモ動画を作れずブロック中。', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st09', startDate: '2026-09-26', dueDate: '2026-10-05', status: 'blocked', dependsOn: 'tk06', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk08', projectId: 'pj01', titleJa: 'EU圏向けプロモーション計画', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st08', startDate: '2026-09-23', dueDate: '2026-10-05', status: 'todo', dependsOn: 'tk04', createdAt: '2026-05-01T00:00:00.000Z' },
  { id: 'tk09', projectId: 'pj01', titleJa: '北米メディア向けプレスリリース', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st12', startDate: '2026-10-06', dueDate: '2026-10-12', status: 'todo', dependsOn: 'tk07', createdAt: '2026-05-01T00:00:00.000Z' },
  // ネオトーキョー2088 (pj02): art → program integration (rough model) → QA on the early build.
  { id: 'tk10', projectId: 'pj02', titleJa: 'アート素材制作(主人公キャラクターデザイン確定)', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st03', startDate: '2026-07-01', dueDate: '2026-09-25', status: 'in-progress', dependsOn: null, createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk11', projectId: 'pj02', titleJa: 'キャラクター実装(仮モデル)', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st02', startDate: '2026-09-26', dueDate: '2026-10-10', status: 'todo', dependsOn: 'tk10', createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk12', projectId: 'pj02', titleJa: '初期ビルド動作確認', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st10', startDate: '2026-10-11', dueDate: '2026-10-25', status: 'todo', dependsOn: 'tk11', createdAt: '2026-07-01T00:00:00.000Z' },
  { id: 'tk13', projectId: 'pj03', titleJa: '起承転結プロット第1稿', titleEn: '', descriptionJa: '', descriptionEn: '', translationStatus: 'untranslated', assigneeId: 'st01', startDate: '2026-08-01', dueDate: '2026-09-18', status: 'in-progress', dependsOn: null, createdAt: '2026-08-01T00:00:00.000Z' },
];
